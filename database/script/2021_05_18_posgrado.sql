...
-- Tiempo de generación: 18-05-2021 a las 19:21:56
...
(1, 'César Gabriel', 'Morales ', 'Gutierrez', 'cesar@gmail.com', '12345'),
(2, 'Keyla Esmeralda', 'Montejo', 'Vazuez', 'keyla@gmail.com', '12345');
...
(2, 'cesar@gmail.com', '$2y$10$f7p4.WR8QQzEm7lVkwpsx.iuVL.NbalmlWmaeR/KVOidtPp13heo.', 5),
(3, 'vanessa@gmail.com', '12345', 3);
...
(1, 'Coordinador 1', 'cordinador@gmail.com', '$2y$10$f7p4.WR8QQzEm7lVkwpsx.iuVL.NbalmlWmaeR', 'Programa educativo 1'),
(2, 'Keyla Esmeralda', 'keyla@gmail.com', '12345', 'Maestría en Ingeniería Bioquímica '),
(3, 'César Gabriel', 'cesar@gmail.com', '12345', 'Maestría en Ciencias de Ingeniería Mecatrónica '),
(4, 'Jose Perez', 'jose@gmail.com', '12345', 'Doctorado en Ciencias de los Alimentos y Biotecnología '),
(5, 'Vanessa del Carmen', 'vanessa@gmail.com', '12345', 'Doctorado en Ciencias de la Ingeniería ');
...
ALTER TABLE `proyectos`
  ADD PRIMARY KEY (`id`,`comite`,`estudiantes_id`),
  ADD KEY `fk_Proyectos_comite1_idx` (`comite`),
  ADD KEY `fk_Proyectos_estudiantes1_idx` (`estudiantes_id`);
...
ALTER TABLE `proyectos`
  ...
  ADD CONSTRAINT `fk_Proyectos_estudiantes1` FOREIGN KEY (`estudiantes_id`) REFERENCES `estudiantes` (`id`);
COMMIT;
